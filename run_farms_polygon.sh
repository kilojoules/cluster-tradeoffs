...
#SBATCH --job-name="farm_poly"
#SBATCH --time=06:00:00
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --exclusive

# Polygon-constrained individual farm optimization.
# Uses tarball for fast env staging (single file copy + extract).
...
echo "=== A=${A}, Farm=${FARM}, seeds ${OFFSET}-$((OFFSET+SEEDS_PER_TASK-1)) ==="
