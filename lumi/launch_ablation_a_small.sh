#!/bin/bash
# Extend a-sweep to smaller (more diffuse) values at f=1.0
cd /scratch/project_465002609/julian_clusters
mkdir -p logs

count=0
for a in 0.1 0.15 0.2 0.25; do
    for dist in 2 10; do
...
echo "${count} small-a ablation jobs submitted (4 a-values x 2 distances = 8)."
