...
The neighbor placement patterns and the directional structure of regret are preserved, though absolute magnitudes differ [results to be added upon completion of LUMI runs].
This confirms that the qualitative conclusions---the dominance of wind rose folding and the ambush effect---are robust to both wake model and superposition choices.
...
\begin{table}
    ...
    \begin{tabular}{llcc}
        ...
        Bastankhah ($k = 0.04$) & Linear & [pending] & [pending] \\
        TurbOPark ($A = 0.04$) & Quadratic & 818.3 & 164.5 \\
        TurbOPark ($A = 0.04$) & Linear & [pending] & [pending] \\
        \bottomrule
    \end{tabular}
\end{table}
