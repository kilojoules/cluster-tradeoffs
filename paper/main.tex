...
Offshore wind energy is expanding rapidly into large-scale clusters, where multiple wind farms share the same marine area.
In the North Sea alone, dozens of farms are planned within wake-interaction distance of each other \citep{Platis2018, Fischereit2022}.
Wind farm wakes can persist for tens of kilometers \citep{Platis2018, Schneemann2020}, reducing downstream farm performance---a phenomenon sometimes called ``wind theft.''

A critical challenge in cluster development is that farms are designed and permitted sequentially, often by different developers.
...
The Danish Energy Island wind rose, when fitted with the elliptical model, has approximately $a \approx 0.5$ and $f \appro 0.15$---firmly in the low-regret region.
