...
#SBATCH --job-name="sweep_rev"
#SBATCH --output=analysis/sweep_rev_%a.out
#SBATCH --time=1-00:00:00
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --exclusive

# Full 2000-seed combined sweep (seeds 0-1999), REVERSED A ordering.
# Processes highest A values first (A=0.30, 0.28, ..., 0.02).
...
#
# Launch: sbatch --array=0-749%50 run_sweep_combined_reverse.sh
...
# 15 A values in DESCENDING order (highest first)
A_VALUES=(0.30 0.28 0.26 0.24 0.22 0.20 0.18 0.16 0.14 0.12 0.10 0.08 0.06 0.04 0.02)
