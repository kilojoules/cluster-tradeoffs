...
Figure~\ref{fig:cross-section} presents regret cross-sections at $K = 100$ for six wind roses (Table~\ref{tab:cross-section}).

\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/cross_section_k100.png}
    \caption{Regret cross-sections at $K = 100$: design regret vs.\ neighbor bearing and distance for a $5 \times 5$ reference farm.
...
\begin{table}[t]
    \centering
    \caption{Peak regret from cross-sections at $K = 100$.
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        DEI real wind rose       & 122.3 & 2.21 & \SI{225}{\degree} & $15D$ \\
        $a = 0.9$, $f = 1.0$    & 117.6 & 2.96 & \SI{315}{\degree} & $15D$ \\
        $a = 0.7$, $f = 0.5$    & 114.2 & 2.89 & \SI{135}{\degree} & $15D$ \\
        $a = 0.9$, $f = 0.0$    &  95.0 & 2.39 & \SI{195}{\degree} & $60D$ \\
        $a = 0.5$, $f = 1.0$    & 163.3 & 4.14 & \SI{135}{\degree} &  $5D$ \\
        $a = 0.5$, $f = 0.0$    &  91.2 & 2.31 &  \SI{90}{\degree} & $15D$ \\
        \bottomrule
    \end{tabular}
\end{table}
...
These cross-sections use $K = 100$, which the convergence study shows may underestimate converged regret by up to \SI{40}{\percent} for some configurations.
The qualitative directional pattern is robust---it is physically grounded and consistent across all six cases---but absolute magnitudes should be interpreted as lower bounds.
